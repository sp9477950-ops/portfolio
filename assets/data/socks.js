const socksProjects = [
  {
    ...
    short: "Pixel-perfect brand logo locked to the toe panel using Gemini vision spatial anchor logic.",
    desc: "A high-precision branding pipeline built for premium socks. This style — the Black Low-Cut — features the logo on the curved toe area, one of the hardest zones to brand consistently. Our Gemini vision model performs real-time garment analysis to inject exact anatomical coordinates, eliminating hallucinations.",
  ...
  },
  {
    ...
    short: "Brand logo anchored to the back cuff/heel-tab on a white & green low-cut style.",
    desc: "The White/Green Collar style places the brand logo on the back cuff heel-tab — a narrow, cylindrical surface that causes most diffusion models to wrap or skew text. This pipeline enforces exact bounding box constraints for clean output every time.",
  ...
  },
  {
    ...
    desc: "Striped patterns are especially challenging — the model must distinguish between stripe boundaries and treat them as non-logo zones. Our dynamic prompt injection identifies the stripe-free side panel and locks the brand logo there with pixel-level accuracy.",
  ...
  },
  {
    ...
    short: "Brand logo anchored to the heel area on a bold yellow & white striped ankle sock.",
  ...
  },
  {
    ...
    short: "Ribbed texture logo placement — brand logo locked to the cuff band of a black crew sock.",
  ...
  },
  {
    ...
    short: "Back-cuff brand logo placement on a premium blue & white striped sock with precise heel-tab lock.",
  ...
  },
  {
    ...
    short: "Brand logo placed on the arch zone of a white & pink ankle collar sock.",
  ...
  },
  {
    ...
    short: "Lateral side branding with brand logo locked between pink stripe boundaries.",
  ...
  },
  {
    ...
    short: "Brand logo cleanly placed on the dark side panel of a black & white striped sock.",
    desc: "The dark side-stripe variant poses a contrast challenge — logo legibility drops on dark fabric with adjacent bright stripes. Our pipeline applies dynamic contrast adjustment alongside spatial anchoring, ensuring the brand text remains crisp and fully legible at all times.",
  ...
  },
  {
    ...
    short: "Full cuff-band branding on a premium black striped crew sock.",
    desc: "The Black Striped Cuff is a premium style with complex ribbing, multiple stripe widths, and a demanding cuff branding zone. This pipeline handles all three constraints simultaneously: ribbing, stripe boundaries, and cuff curvature — delivering the brand's premium catalog hero shot reliably.",
    ...
    feat: [
      ...
      "Scales across entire product catalog"
    ],
